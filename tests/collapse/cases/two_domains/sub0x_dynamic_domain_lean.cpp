...
namespace {
struct Sample { uint32_t value; using sub0_config = sub0x::config<sub0x::Scoped, sub0x::Direct, sub0x::NoContext, sub0x::NoFilter>; }; // lean: no snapshot, context or filter (none used here)
