/** Case: multiple receivers including a repeated type. Type-erased reference: a non-template publisher written by hand the C way -- a context pointer to a node
